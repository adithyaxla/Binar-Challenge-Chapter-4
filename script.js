...
class Start {
  ...
  winRules() {
    if (this.compOption == paperComp && this.playerOption == scissorPlayer) {
      ...
      this.compOption == paperComp &&
      this.playerOption == rockPlayer
    ) {
      this.winner = this.botName;
    } else if (
      this.compOption == scissorComp &&
      this.playerOption == paperPlayer
    ) {
      this.winner = this.botName;
    } else if (
      this.compOption == scissorComp &&
      ...
      this.compOption == rockComp &&
      this.playerOption == paperPlayer
    ) {
      this.winner = this.playerName;
    } else if (
      this.compOption == rockComp &&
      this.playerOption == scissorPlayer
    ) {
      this.winner = this.botName;
    } else {
      this.winner = "DRAW";
